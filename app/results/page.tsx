...
export const metadata: Metadata = { title: "Results | Rolodex Rebels" };

export default function Results() {
  return (
    <InternalPage eyebrow="Results" title={<>NOISE IS GOOD.<br /><span>RESULTS ARE BETTER.</span></>} intro="We judge campaigns by what changed: stronger discovery, deeper fan relationships, more ticket demand and clearer decisions about what comes next.">
