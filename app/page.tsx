...
export default function Home() {
  return <main>
    ...
    <footer className="site-footer"><Image src="/images/03.png" alt="Rolodex Rebels PR Marketing" width={280} height={338} className="footer-mark" /><p>Copyright Rolodex Rebels 2026<br />Website created by <a href="https://parkerscreative.co.uk/" target="_blank" rel="noreferrer">Parkers Creative</a></p></footer>
  </main>;
}
