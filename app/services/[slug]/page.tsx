...
const serviceData = {
  ...
  "digital-creative": {
    ...
    answer: "Digital & Creative is the infrastructure behind audience growth. We shape websites, campaign experiences, audience journeys and content for artists, bands, events, festivals, venues, promoters and music organisations. Everything starts with what the audience needs to discover, understand and do — then uses useful measurement to guide improvement. We can build it, run it and improve it with you.",
    ...
    items: [
      ...
      ["Audience journeys", "Clear, permission-based routes to sign-up, RSVP, stay informed and build a useful fan or audience relationship."],
      ...
      ["Measurement & improvement", "Consent-aware signals from campaign response, site behaviour and CTA engagement that can inform the next move."],
