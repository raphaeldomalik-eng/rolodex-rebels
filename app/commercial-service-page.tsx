...
export const commercialServices: Record<string, CommercialServiceData> = {
  ...
  flyerDistribution: {
    ...
    connectionCopy: "Where it helps, a QR code or dedicated campaign URL can give the flyer a clear digital next step — tickets, a release, RSVP, content or sign-up — and provide additional response signals where measurable.",
