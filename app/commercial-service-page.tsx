...
export const commercialServices: Record<string, CommercialServiceData> = {
  musicPr: {
    ...
    connectionCopy: "A feature, interview or review can point people towards the release, live dates, an artist page or a permission-based fan sign-up. That gives earned attention somewhere to go instead of letting the moment disappear.",
  ...
  flyerDistribution: {
    ...
    capabilities: [
      ...
      ["Campaign support", "Use leaflets and flyers alongside posters, PR, digital activity, ticket campaigns and wider grassroots activation."],
  ...
  festivalMarketing: {
    ...
    outcome: "A festival campaign that moves with the ticket picture and leaves a permission-based audience to communicate with after the gates close.",
