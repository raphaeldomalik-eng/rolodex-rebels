...
const strengths = [
  ...
  ["Online And On The Ground", "We promote campaigns online, through the media and out in the real world — outside venues, on campuses and where the audience actually is."],
  ["One Team. Less Running Around.", "PR, social media, websites, ticket campaigns and street promotion can work together instead of being handled separately."],
  ...
  return (
    <InternalPage eyebrow="Why Rolodex Rebels?" title={<>FROM THE STREETS<br />TO THE <span>SCREENS.</span></>} intro="We promote music and events online, through the media and out in the real world — so the campaign reaches people where they actually are." breadcrumbs={[{ name: "Home", path: "/" }, { name: "Why Us", path: "/why-us" }]}>
      <section className="inner-split">
        ...
        <div className="body-copy"><p>Before dashboards and discovery feeds, there were venues, high streets, campuses and queues. They still matter. We know how to put a release, show or festival in front of people face to face — and how to carry that into PR, social media, websites and ticket campaigns.</p><p>That is what “From the streets to the screens” means: reach people wherever the campaign needs to be, then give them a clear reason to act.</p></div>
      </section>
